...
public class MyCustomAdapter extends ArrayAdapter<Shape> {
    private final ArrayList<Shape> shapesArrayList;
    Context context;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            // no view went off-screen --> Create a new
    ...
    // View Holder: Used to caches references to the views within an item layout.
